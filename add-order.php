...
<?php include("sidebar.php"); ?>
    <div class="box">
    <form action="add-order_udb.php" method="post" onsubmit="return order_added()" enctype="multipart/form-data" style="padding: 40px 374px;">
                


    <!-- !!!!!!!!!!!!!!!! create acc order table and also set ord table !!!!!!!!!!!!!!!!!!!!!!!  -->
                ...
                <input type="text" name="maincat" require><br><br>
